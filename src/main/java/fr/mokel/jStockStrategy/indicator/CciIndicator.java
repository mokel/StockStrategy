...
import fr.mokel.jStockStrategy.functions.MeanDeviation;
import fr.mokel.jStockStrategy.functions.TypicalPrice;
import fr.mokel.jStockStrategy.gui.util.SwingField;
import fr.mokel.jStockStrategy.model.DayValue;

public class CciIndicator implements IndicatorChart {
